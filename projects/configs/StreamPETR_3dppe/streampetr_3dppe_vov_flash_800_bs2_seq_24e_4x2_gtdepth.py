...
collect_keys = ['lidar2img', 'intrinsics', 'extrinsics', 'timestamp',
                'img_timestamp', 'ego_pose', 'ego_pose_inv', 'depth_map', 'depth_map_mask']
input_modality = dict(
    use_lidar=False,
    use_camera=True,
    use_radar=False,
...
# Train:
# ./tools/dist_train.sh projects/configs/StreamPETR_3dppe/streampetr_3dppe_vov_flash_800_bs2_seq_24e_4x2_gtdepth.py 4

# Val:
# ./tools/dist_test.sh projects/configs/StreamPETR_3dppe/streampetr_3dppe_vov_flash_800_bs2_seq_24e_4x2_gtdepth.py  work_dirs/streampetr_3dppe_vov_flash_800_bs2_seq_24e_4x2_gtdepth/latest.pth 4 --eval bbox
...
# car     0.779   0.273   0.146   0.074   0.231   0.183
# truck   0.558   0.477   0.203   0.074   0.188   0.203
# bus     0.588   0.543   0.206   0.072   0.403   0.304
# trailer 0.297   0.806   0.235   0.565   0.176   0.188
# construction_vehicle    0.263   0.819   0.480   0.996   0.134   0.336
# pedestrian      0.636   0.446   0.283   0.474   0.287   0.152
# motorcycle      0.593   0.376   0.262   0.451   0.351   0.257
# bicycle 0.488   0.384   0.252   0.710   0.165   0.011
# traffic_cone    0.662   0.352   0.311   nan     nan     nan
# barrier 0.665   0.304   0.278   0.164   nan     nan

# Save:
# https://www.aliyundrive.com/s/b8XpvWbu5DW
